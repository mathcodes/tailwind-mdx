...
const FeedbackThanks = forwardRef(function FeedbackThanks(_props, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-orange-50/50 py-1 pr-3 pl-1.5 text-sm text-orange-900 ring-1 ring-inset ring-orange-500/20 dark:bg-orange-500/5 dark:text-orange-200 dark:ring-orange-500/30">
