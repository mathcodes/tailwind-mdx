...
- [Sliding Window](#sliding-window)
  ...
  - [Triplets that sum to zero (medium)](#triplets-that-sum-to-zero-medium)
- [Two Pointers](#two-pointers)
  - [Pair with target sum (easy)](#pair-with-target-sum-easy)
  - [Remove duplicates (easy)](#remove-duplicates-easy)
  - [Squaring a sorted array (easy)](#squaring-a-sorted-array-easy)
  - [Triplet sum to zero (medium)](#triplet-sum-to-zero-medium)
  - [Triplet sum close to target (medium)](#triplet-sum-close-to-target-medium)
  - [Triplets with smaller sum (medium)](#triplets-with-smaller-sum-medium)
  - [Subarrays with product less than a target (medium)](#subarrays-with-product-less-than-a-target-medium)
  - [Dutch national flag problem (medium)](#dutch-national-flag-problem-medium)
